...
function removeItem(arr, str){
	let newArr=arr.filter((element)=>element!==str)
	return newArr
}

// removeItem(arr, "three")
...
function makeChatMessage(mes, auth){
	return {
		message: mes,
		author: auth,
		timestamp: new Date()
...
// invokes it(holla) passing in "back + " back""
